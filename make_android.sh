...
k26f_byos_s5_p=k26f_byos_s5

k26_vst_s1_p=k26_vst_s1
...
k89_zc_develop_p=k89_zc_develop
...
k86mx1_meiban_m8a_p=k86mx1_meiban_m8a
k86mx1_kkxl_c9_p=k86mx1_kkxl_c9
k86mx1_kkxl_c9x_p=k86mx1_kkxl_c9x
...
function is_yunovo_project
{
    ...
    case $thisP in
        ...
        $k26s_xianzhi_t99_p | $k26_vst_s1_p | $k26f_byos_s5_p | $k26e_vst_k3_p)
            echo true

            ;;

        $k27_hbs_t2_p | $k27_xinke_ds50_p | ${k27_aj_ajs_p}-1 | $k27_vst_d1_p | $k27l_fxft_c66_p)
            echo true
        ...
        $k89_ld_hs720a_p | $k89_zc_develop_p)
            echo true
            ;;
        ...
        $k86mx1_jh_s04a_p | $k86mx1_jh01_s04a_p | $k86mx1_rwy_dz80_p | $k86mx1_byos_s8_p | $k86mx1_meiban_m8a_p | $k86mx1_meiban_m8s_p | $k86mx1_kkxl_c9_p | $k86mx1_kkxl_c9x_p)
            echo true
...
{
    local cpu_type_more=(aeon6735_65c_s_l1 aeon6735m_65c_s_l1 magc6580_we_l ea6735_65c_a_l1 aeon6735_66c_m0)
    local cpu_type=$1
