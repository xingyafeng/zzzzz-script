...
function cpfs()
{
    ...
    if [ $sz_hostname == "s1" -o $sz_hostname == "s2" -o $sz_hostname == "s3" -o $sz_hostname == "s4" -o $sz_hostname == "s5" -o $sz_hostname == "f1" ];then
...
function sshfs-server()
{
    ...
    local share_path=/public/jenkins
...
{
    local server_ip=`echo s1.y s2.y s3.y s4.y s5.y happysongs f1.y p1.y`
    local portN=22
