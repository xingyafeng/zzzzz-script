...
function is_yunovo_server()
{
    ...
    local serverN=(s1 s2 s3 s4 s5 happysongs ww he-All-Series. yangmingming p1)
...
function handler_branch_for_YOcMediaFolder()
{
    ...
    if [ $build_prj_name == "k26s_LD-A107C" -o $build_prj_name == "k89_LD-HS830A" -o $build_prj_name == "k89_LD-HS720A" -o $build_prj_name == "k86mx1_LD-ZX" ];then
...
function handler_branch_for_TxzVoice()
{
    ...
    case $build_prj_name in
        ...
        k86s7_NM-N810 | k86mx1_MB-M8S | k86ls_K80 | k86mx1_MB-M8A | k26s_MB-M60)
...
function handler_branch_for_TxzCore()
{
    ...
    case $build_prj_name in
        ...
        k86s7_NM-N810 | k88s_NM-D200 | k88s_NM-D210 | k86mx1_MB-M8S | k86ls_K80 | k86mx1_MB-M8A | k26s_MB-M60)
...
function auto_update_yunovo_customs()
{
    ...
    elif [ $hostN == "s1" -o $hostN == "s2" -o $hostN == "s3" -o $hostN == "s4" -o $hostN == "s5" -o $hostN == "p1" ];then
