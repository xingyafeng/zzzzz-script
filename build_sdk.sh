...
### clone system app
commond_app=(FactoryTest CarEngine CarHomeBtn CarSystemUpdateAssistant CarPlatform GaodeMap KwPlayer UniSoundService CarConfig)
...
k86l_app=(CarUpdateDFU CarRecordDouble CarRecordUsb StormVideo GpsTester XianzhiDSA FileCopyManager GaodeCarMap)
