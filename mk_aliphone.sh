...
function is_yunos_project
{
    ...
    case $thisP in
        ...
        $mx1_kkxl_v9_p | $mx1_kkxl_v9_ts_p | $mx1_teyes_t8_p | $mx1_teyes_t8s_p | $mx1_teyes_t8_new_p | $mx1_anytek_m960_p | $mx1_teyes_t7_p | $mx1_renwoyou_dz86_p)
            echo true
